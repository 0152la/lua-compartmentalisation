...
silent only
silent tabonly
cd ~/Documents/Kings/CHERI/lua-compartmentalisation/src
...
exe 'vert 4resize ' . ((&columns * 158 + 158) / 317)
argglobal
balt compartment.h
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 30 - ((24 * winheight(0) + 17) / 35)
...
wincmd w
argglobal
if bufexists("compartment.h") | buffer compartment.h | else | edit compartment.h | endif
balt ~/Documents/Kings/CHERI/lua-compartmentalisation/tests/hello_world_wrap.c
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.cpp") | buffer ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.cpp | else | edit ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.cpp | endif
balt ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/compartment-manager/compartment_manager.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 106 - ((6 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 106
...
argglobal
if bufexists("~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.cpp") | buffer ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.cpp | else | edit ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.cpp | endif
balt ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 373 - ((26 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 373
...
exe 'vert 4resize ' . ((&columns * 158 + 158) / 317)
tabnext 1
badd +4 compartment.h
badd +3 manager.h
badd +6 compartment.c
badd +214 ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.cpp
badd +39 ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/elf_util.h
badd +339 ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/compartment-manager/compartment_manager.cpp
badd +95 ~/Documents/Kings/CHERI/lua-compartmentalisation/tests/hello_world_wrap.c
badd +4 ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/compartment-manager/compartment_manager.h
badd +9 ~/Documents/Kings/CHERI/morello-examples/compartment-demo/src/utils/align.h
